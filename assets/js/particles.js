var pJS = function(tag_id, params){
  ...
  pJS.fn.canvasSize = function()
  {
    ...
    if
    (
      pJS && pJS.interactivity.events.resize
    )
    {
  ...
  pJS.fn.particle = function(color, opacity, position)
  {
    ...
    if
    (
      this.x > pJS.canvas.w - this.radius*2
    )
    ...
    if
    (
      this.y > pJS.canvas.h - this.radius*2
    )
    ...
    )
    {
      ...
      else
      {
        if
        (
          color.value.r != undefined && color.value.g != undefined && color.value.b != undefined
        )
        {
          this.color.rgb =
          {
        ...
        if
        (
          color.value.h != undefined && color.value.s != undefined && color.value.l != undefined
        )
        {
          this.color.hsl =
          {
    ...
    )
    {
      ...
      if
      (
        !pJS.particles.opacity.anim.sync
      )
      {
...
window.particlesJS = function(tag_id, params){
  ...
  /* set size canvas */
  canvas_el.style.width = "1920px";
  canvas_el.style.height = "780px";
